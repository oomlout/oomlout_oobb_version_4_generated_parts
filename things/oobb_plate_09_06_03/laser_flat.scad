				...
				difference() {
						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 6) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_plate_shape_p_type_3_depth_9_width_6_height_3_thickness_true_both_holes", valign = "center");
								}
							}
						}
						hull() {
					...
					union() {
						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 6) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_9_width_6_height_3_thickness_true_both_holes", valign = "center");
								}
							}
						}

...
difference() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [-30.0000000000, 21.5000000000, 0]) {
				linear_extrude(height = 2) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_plate_shape_p_type_3_depth_-30.0_7.5_0_pos_1_width_2_height_3_thickness_false_full_object", valign = "center");
				}
			}
		}
	...
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [-30.0000000000, 21.5000000000, 0]) {
				linear_extrude(height = 2) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_-30.0_7.5_0_pos_1_width_2_height_3_thickness_false_full_object_true_both_holes", valign = "center");
				}
			}
		}
		translate(v = [-30.0000000000, 0.0000000000, 0]) {

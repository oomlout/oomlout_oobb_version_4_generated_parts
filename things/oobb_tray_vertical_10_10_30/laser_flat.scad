			...
			intersection() {
				...
				difference() {
					...
					union() {
						...
						translate(v = [0, 0, 3]) {
							#hull() {
								union() {
									...
									translate(v = [-69.5000000000, 69.5000000000, 27]) {
										sphere(r = 4);
									}
								}
								union() {
						...
						#translate(v = [-90.0000000000, -67.5000000000, 37.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 20, r = 3.0000000000);
							}
						}
						#translate(v = [-90.0000000000, -52.5000000000, 37.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 20, r = 3.0000000000);
							}
						}
						#translate(v = [-90.0000000000, -37.5000000000, 37.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 20, r = 3.0000000000);
							}
						}
						#translate(v = [-90.0000000000, -22.5000000000, 37.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 20, r = 3.0000000000);
							}
						}

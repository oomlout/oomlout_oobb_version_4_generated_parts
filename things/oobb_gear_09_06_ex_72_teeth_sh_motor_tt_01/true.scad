...
difference() {
	...
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 5]) {
				linear_extrude(height = 1) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_motor_tt_01_shape_n_type_50_depth_0_0_5_pos_9_diameter_6_thickness_motor_tt_01_shaft_shaft_part", valign = "center");
				}
			}
		}

				...
				difference() {
					union() {
						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 1) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_plate_shape_p_type_9_depth_30_width_1_height_9_thickness_true_both_holes", valign = "center");
								}
							}
						}
						hull() {
					...
					union() {
						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 1) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_30_width_1_height_9_thickness_true_both_holes", valign = "center");
								}
							}
						}

			...
			intersection() {
				...
				difference() {
					...
					union() {
						...
						translate(v = [0, 0, 3]) {
							#hull() {
								union() {
									...
									translate(v = [-107.0000000000, 69.5000000000, 6]) {
										sphere(r = 4);
									}
								}
								union() {
						...
						#translate(v = [-127.5000000000, -67.5000000000, 16.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 20, r = 3.0000000000);
							}
						}
						#translate(v = [-127.5000000000, -52.5000000000, 16.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 20, r = 3.0000000000);
							}
						}

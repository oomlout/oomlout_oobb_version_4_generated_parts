...
difference() {
	...
	union() {
		...
		translate(v = [0, 0, 3]) {
			#hull() {
				union() {
					...
					translate(v = [-107.0000000000, 99.5000000000, 87]) {
						sphere(r = 4);
					}
				}
				union() {
		...
		#translate(v = [-127.5000000000, -97.5000000000, 97.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
		#translate(v = [-127.5000000000, -82.5000000000, 97.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}

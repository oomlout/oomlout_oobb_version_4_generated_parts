							...
							rotate(a = [0, 0, 180]) {
								difference() {
									union() {
										...
										translate(v = [-0.7960000000, -2.6900000000, -2.6000000000]) {
											cube(size = [7.3000000000, 7.9200000000, 2.6000000000]);
										}
										translate(v = [8.8880000000, -0.1500000000, -2.6000000000]) {
											cube(size = [14.3000000000, 5.3800000000, 2.6000000000]);
										}
										translate(v = [6.3500000000, -5.2300000000, -2.6000000000]) {
